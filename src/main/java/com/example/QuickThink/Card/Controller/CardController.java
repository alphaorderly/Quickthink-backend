...
import com.example.QuickThink.Card.Dto.CardWriteResponseDto;
...
public class CardController {
    ...
    @PostMapping("/write")
    public ResponseEntity<CardWriteResponseDto> postCard(@RequestHeader("accessToken") String accessToken, @RequestBody @Valid CardWriteRequestDto cardWriteRequestDto) {
        CardWriteResponseDto cardWriteResponseDto = cardService.postCard(accessToken, cardWriteRequestDto);
        return new ResponseEntity<>(cardWriteResponseDto, HttpStatus.OK);
    }
