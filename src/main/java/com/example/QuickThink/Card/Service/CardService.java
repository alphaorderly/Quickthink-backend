...
public class CardService {
    ...
    @Transactional
    public CardWriteResponseDto postCard(String accessToken, CardWriteRequestDto cardWriteRequestDto) {
        ...
        return new CardWriteResponseDto(cardRepository.save(newCard).getId());
    }
    ...
    public void editCard(String accessToken, Long cardId, CardEditRequestDto cardEditRequestDto) {
        ...
        card.updateCard(cardEditRequestDto.getTitle(), cardEditRequestDto.getContent(), new HashSet<>(cardEditRequestDto.getHashTags()), cardEditRequestDto.getWrittenDate());
    ...
    public void reviewCard(String accessToken, Long cardId) {
        ...
        card.reviewCard(LocalDateTime.now());
    }
